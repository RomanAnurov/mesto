...
const popupEditButton = document.querySelector(".popup_type_edit-profile");
const closePopupButton = popupEditButton.querySelector(".popup__close");

function popupOpenToggle() {
  popupEditButton.classList.toggle("popup_type_opened");
}
...
// Находим форму в DOM
const formElement = popupEditButton.querySelector(".popup__form"); // Воспользуйтесь методом querySelector()
